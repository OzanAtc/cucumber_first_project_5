$(document).ready(function() {var formatter = new CucumberHTML.DOMFormatter($('.cucumber-report'));formatter.uri("src/test/resources/features/pagination_page.feature");
formatter.feature({
  "name": "TechGlobal Pagination Page Main Content",
  "description": "",
  "keyword": "Feature"
});
formatter.scenario({
